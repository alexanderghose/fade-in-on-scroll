...
const allSections = document.querySelectorAll(".animate-me");
...
window.addEventListener("scroll", function(event) {
    ...
    for (let section of allSections) {
        ...
        if (window.scrollY >= (section.offsetTop - window.innerHeight)) {
            ...
            section.classList.add("fade-in-up-animation")
        } else {
            section.classList.remove("fade-in-up-animation")
        }
    }
})
